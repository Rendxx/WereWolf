...
var Prepare = function(container, opts_in) {
  ...
  var _renderClient = function(clientData) {
    ...
    if (recoverNumber) {
      playerList.recoverClientNumber(JSON.parse($$.cookie.get("clientNumber")));
      recoverNumber = false;
    }
  ...
  var _init = function(opts_in) {
    ...
    playerList.onChange=function(){
      $$.cookie.set("clientNumber", JSON.stringify(playerList.getClientNumber()));
    };
